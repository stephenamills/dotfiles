# PDF-and-Transcript Study Manual Prompt

Transform exactly one primary PDF and one or more explicitly corresponding lesson transcripts into one comprehensive Markdown study manual for *Professional Trading Masterclass*.
...
- Manual: `<lesson-number>PDF. <Topic> - PDF Study Manual.md`
...
- Generation audit: `pdf-manual-<lesson-number>-audit-<topic-slug>.md`
